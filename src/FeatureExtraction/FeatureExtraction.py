...
import pandas as pd
from FeatureExtraction import featureSwitcher, extractorSwitcher
...
class FeatureSet:
    ...
    def __init__(self, config_path, url_list):
        ...
        extractor = selectedFeatures["Extractor"]
        self.Extractor = extractorSwitcher(extractor)
